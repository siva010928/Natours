...
var mapMarker = function mapMarker(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2l2YTAxMDkyOCIsImEiOiJja25sZHZoaGswNDYxMndsaWZ0NWxwNHVzIn0.XKjwISSYcsLsC5Cw0W7YWA';
...
var showAlert = function showAlert(result, message) {
  hideAlert();
  var markUp = "<div class=\"alert alert--".concat(result, "\">").concat(message, "</div>");
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = type === 'user-data' ? '/api/v1/users/updateMe' : '/api/v1/users/updateMyPassword';
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type, " Successfully updated")); //   location.reload(true);
            }
...
var stripe = Stripe('pk_test_51IibuMSCXtL5yOrlVd1j68ZPkoUTrPPSBYnrqjIHasD7pxp5ZzcYUt0rw6qYDnAF5o2dswemdsbgDhNXRwtxZEho00ycDgTOSe');
...
var checkOutBtn = document.getElementById('book-tour');

if (map) {
  var locations = JSON.parse(document.getElementById('map').dataset.locations);
  (0, _mapBox.mapMarker)(locations);
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 11;
              return (0, _settings.updateData)(formdata, 'user-data');
